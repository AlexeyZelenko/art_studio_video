...
const VideoServices = () => {
  const { getActiveVideoServices, servicesLoading } = useVideo();
  const activeServices = getActiveVideoServices();
  ...
  const getIcon = (iconName: string) => {
    ...
    return IconComponent ? IconComponent : LucideIcons.Video;
  };
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <div className="text-xl text-gray-600">Завантаження відео послуг...</div>
          </div>
        </div>
      </section>
    );
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            Створюємо кінематографічні відео, що розповідають вашу унікальну історію. 
            Від весільних фільмів до корпоративних презентацій - кожен проект унікальний.
          </p>
        </motion.div>
        ...
        {activeServices.length > 0 ? (
          ...
          <div className="text-center py-16">
            <p className="text-xl text-gray-500">
              Відео послуги тимчасово недоступні
            </p>
          </div>
        )}
      </div>
